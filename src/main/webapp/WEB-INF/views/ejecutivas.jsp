...
<body layout="column" ng-controller="ejecutivasCtrl as vm">
			...
			<md-content layout="column" flex class="md-padding">
				<div class="table-responsive-vertical shadow-z-1">
				  <table id="table" class="table table-hover table-mc-light-blue" at-table at-paginated at-list="list" at-config="config" rules="none">
				      ...
				      <tbody>
				        <tr ng-repeat="ejecutiva in list|filter:search| orderBy:'-nombre'">
				          <td colspan="2" data-title="Nombre">{{ejecutiva.nombre}}</td>
				          <td colspan="2" data-title="Apellido">{{ejecutiva.apellido}}</td>
				        </tr>
				      </tbody>
				    </table>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/angularjs/ejecutiva.js"></script>
</html>