...
<html ng-app="loginApp">
	...
	<body>
		<div  layout="row" layout-align="center center" ng-cloak="">
			<form name="loginForm" layout="column" class="md-whiteframe-z1" ng-controller="loginCtrl">
				<md-toolbar >
				...
				<md-content class="md-no-momentum">
					...
					<md-input-container class="md-icon-float md-block margincero">
					...
					<md-input-container layout="column" layout-align="center">
						<md-button ng-click="validateLogin()" class="md-raised md-primary">Iniciar sesi&oacute;n</md-button>
