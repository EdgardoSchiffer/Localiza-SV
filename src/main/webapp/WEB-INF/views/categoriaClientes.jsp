<!DOCTYPE html>
<html ng-app="categoriaClientesApp">
<head>
...
<body layout="column" ng-controller="categoriaClienteCtrl as vm">
			...
			<md-content layout="column" flex class="md-padding">
				<div class="table-responsive-vertical shadow-z-1">
				  <table id="table" class="table table-hover table-mc-light-blue" at-table at-paginated at-list="list" at-config="config" rules="none">
				      <thead id="tblTitle">
				        <tr>
				          <th>Categorias de trabajos técnicos</th>
				          <th>
				      ...
				      <tbody>
				        <tr ng-repeat="categoria in list|filter:search| orderBy:'-id'">
				          <td class="hidden">{{categoria.id}}</td>
				          <td data-title="Categoria cliente">{{categoria.tipo_cliente}}</td>
				          <td data-title="Descripci&oacute;n">{{categoria.descripcion}}</td>
				          <td class="right-align">
				          	<a ng-click="deleteFunction($event, categoria)" href="">
				          		<i class="material-icons crudEliminar">delete_forever</i>
				          	</a>
				          	<a ng-click="updateFunction($event, categoria)" href="">
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/angularjs/categoriaClientes.js"></script>
</html>