var app = angular.module("clientesApp", ['ngMaterial', 'ngCookies'])
...
var json;
var tipo;
app.controller('clientesCtrl',  function($mdSidenav, $scope, $mdDialog, $mdMedia, $http, $httpParamSerializer, getList, $mdToast) {
	  var vm = this;
	  $scope.tipoCliente = {};
	      ...
	      .success(function(data){
	    	  $scope.list = {};
	  			...
	  			if (data) {
	  				$mdToast.show(
	  				      $mdToast.simple()
	  				        .textContent('Cliente eliminado con exito')
	  				        .position(pinTo )
	  				        .hideDelay(3000)
	  				    );
				}else{
