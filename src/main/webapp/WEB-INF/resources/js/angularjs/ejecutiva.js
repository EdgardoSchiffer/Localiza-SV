var app = angular.module("ejecutivasApp", ['ngMaterial', 'ngCookies'])
...
var json;
app.controller('ejecutivasCtrl',  function($mdSidenav, $scope, $mdDialog, $mdMedia, $http, $httpParamSerializer, getList, $mdToast) {
	  var vm = this;
